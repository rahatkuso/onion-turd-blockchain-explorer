...
/**
* Parse turd address in a string form into
...
/**
* Return string representation of turd address
*/
string
...
{
    // default path to turd folder
    // on linux this is /home/<username>/.turd
    string default_turd_dir = tools::get_default_data_dir();

    if (nettype == cryptonote::network_type::TESTNET)
        default_turd_dir += "/testnet";
    if (nettype == cryptonote::network_type::STAGENET)
        default_turd_dir += "/stagenet";


    // the default folder of the lmdb blockchain database
    // is therefore as follows
    return default_turd_dir + string("/lmdb");
}
