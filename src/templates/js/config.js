var config = {
    ...
    coinUnitPlaces: 9,
    txMinConfirms: 10,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in Turd
    txCoinbaseMinConfirms: 60, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in Turd
    coinSymbol: 'TUR',
    openAliasPrefix: "lok",
    coinName: 'Turd',
    coinUriPrefix: 'turd:',
