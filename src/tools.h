...
#ifndef TUREG01_TOOLS_H
#define TUREG01_TOOLS_H

#define PATH_SEPARARTOR '/'

#define TUR_AMOUNT(value) \
                  ...
                  bool zero_to_question_mark=true)
{
    ...
    {
        amount_str = fmt::format(_format, TUR_AMOUNT(lok_amount));
    }
    else
    {
